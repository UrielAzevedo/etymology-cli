...
arch=('x86_64')
url="https://github.com/UrielAzevedo/etmology-cli.git"
license=(MIT)
...
package() {
    ...
    install -Dm755 "${srcdir}/etymology.py" "${pkgdir}/usr/bin/etymology-cli"
    chmod +x "${pkgdir}/usr/bin/etymology-cli"

	install -Dm644 "${srcdir}/etymology.1" "${pkgdir}/usr/share/man/man1/etymology.1"
}
